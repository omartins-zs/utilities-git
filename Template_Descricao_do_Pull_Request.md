...
## 📖 Contexto  
Descrever o contexto do problema que está sendo resolvido.

---

## ✅ O que foi feito  
Listar as melhorias, ajustes e implementações realizadas (sem código).
...
Incluir detalhes técnicos relevantes, decisões tomadas e possíveis impactos em outras áreas do sistema.
